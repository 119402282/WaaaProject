        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="index.jsp"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><i class="typcn typcn-pen"></i></span><span>Abstract Solutions</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <c:when test="${user.type == 'admin'}"><a class="btn btn-primary shadow" role="button" href="profiledetails.jsp">Admin</a></c:when>
            ...
            <div class="row pt-5" style="padding: 0px !important;">
                <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                    <div class="text-center">
                        <h1 class="fw-bold">Admin Directory</h1> <a class="btn btn-primary shadow" role="button" href="userAdmin?action=listUsers">User Administrator</a>
